...
async def _(event):
    ...
    joinu = await sython(JoinChannelRequest('ICTS_930'))
...
async def _(event):
      await event.reply("""السـورس يعمـل | mhmad
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍

- المطور : محمد السيد | SOMY

- سورس بسيط يحتوي على الاوامر المهمة التي تحتاجها

قناة السورس : https://t.me/ICTS_930
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@sython.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""SY OWNER : @mmaahg"""
)
